<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:93:"D:\phpStudy\PHPTutorial\WWW\1\atpdemo\tp_1\public/../application/index\view\index\popone.html";i:1535601613;}*/ ?>
<!doctype html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<body>
	<form action="<?php echo url('/xgadmin/index/add'); ?>" method='post' id='zige'>
		...
		<div class="phone">
			邮箱
			<input type="eamil" placeholder='请填写您的邮箱'  class='input' name="eamil">
		</div>
		<div class="phone">
			备注
		...
		<input type="hidden" name="__hash__" value="<?php echo \think\Request::instance()->token('__hash__'); ?>" />
		<div class="submit">
