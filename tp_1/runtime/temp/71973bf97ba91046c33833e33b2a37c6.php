<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"D:\phpStudy\WWW\tp_1\public/../application/admin\view\author\update.html";i:1533478444;s:72:"D:\phpStudy\WWW\tp_1\public/../application/admin\view\public\layout.html";i:1533478971;}*/ ?>
<!doctype html>
<html lang="en">
<head>
  <meta charset="UTF-8">
		...
		<div class="panel-body">
            <form action="" method="POST">
                ...
                <div class="form-group">
                    <label for="">作者</label>
                    <input type="text" name="name" class="form-control" id="" value="<?php echo $data['name']; ?>">
                </div>
    ...
    $(function() {
        $('#file_upload').uploadify({
            ...
            onUploadSuccess:function(file,data,response){
                img="<img src='__STATIC__/uploads/author/"+data+"' alt='' width='200px' height='80px'>";
                $("#queue").html(img);
                $('#addImg').val(data);
