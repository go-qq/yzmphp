<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"/usr/share/nginx/html/tp_1/public/../application/xgadmin/view/article/add.html";i:1533479242;s:80:"/usr/share/nginx/html/tp_1/public/../application/xgadmin/view/public/layout.html";i:1533866265;}*/ ?>
<!doctype html>
<html lang="en">
<head>
  <meta charset="UTF-8">
		...
		<div class="panel-body">
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <select name="columid" class="form-control">
                        <?php if(is_array($col) || $col instanceof \think\Collection || $col instanceof \think\Paginator): $i = 0; $__LIST__ = $col;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$col): $mod = ($i % 2 );++$i;?>
                            <option value="<?php echo $col['id']; ?>">!-<?php echo str_repeat('-',$col['level']) ?><?php echo $col['name']; ?></option> 
