<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"/usr/share/nginx/html/tp_1/public/../application/xgadmin/view/colum/index.html";i:1533471459;s:80:"/usr/share/nginx/html/tp_1/public/../application/xgadmin/view/public/layout.html";i:1533866265;}*/ ?>
<!doctype html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
<div class="col-md-10">
  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      ...
      <a class="btn btn-primary" href="<?php echo url('add'); ?>"  style='color:#fff;'><span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;添加栏目</a>
            ...
            <table class="table table-bordered table-hover">
                ...
                <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$dat): $mod = ($i % 2 );++$i;?>
                    <tr>
                        ...
                        <th>|-<?php echo str_repeat('-',$dat['level'])  ?><?php echo $dat['name']; ?></th>
                        <th><?php echo $dat['type']==0?'图片':'列表'; ?></th>
                        <th>
                            <a href="<?php echo url('del',array('id'=>$dat['id'])); ?>" class='glyphicon glyphicon-trash'>删除</a> |
                            <a href="<?php echo url('update',array('id'=>$dat['id'])); ?>" class='glyphicon glyphicon-pencil' >修改</a>
                        </th>
                    </tr>
